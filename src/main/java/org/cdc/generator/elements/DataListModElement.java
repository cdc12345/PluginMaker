...
public class DataListModElement extends GeneratableElement {
	...
	public static class DataListEntry implements Cloneable {
		...
		public static DataListEntry copyCommonValueOf(DataListEntry dataListEntry) {
			var datalistEntry1 = new DataListEntry(dataListEntry.name, dataListEntry.readableName, dataListEntry.type,
					dataListEntry.texture, dataListEntry.description);
		...
		public DataListEntry(String name, @Nullable String readable_name, @Nullable String type,
				@Nullable String texture, @Nullable String description) {
			this.name = name;
