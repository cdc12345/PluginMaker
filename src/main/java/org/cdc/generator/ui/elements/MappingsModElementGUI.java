...
public class MappingsModElementGUI extends ModElementGUI<MappingsModElement> {
    ...
    public ArrayList<MappingsModElement.MappingEntry> mappingsContent;
    ...
    protected void initGUI() {
        ...
        configuration.add(HelpUtils.wrapWithHelpButton(this.withEntry("pluginmappings/generator"), L10N.label("elementgui.pluginmappings.generator")));
        ...
        configuration.add(HelpUtils.wrapWithHelpButton(this.withEntry("pluginmappings/datalistname"), L10N.label("elementgui.pluginmappings.datalist_name")));
        ...
        configuration.add(HelpUtils.wrapWithHelpButton(this.withEntry("pluginmappings/datalistname"), L10N.label("elementgui.pluginmappings.default_mapping")));
        ...
        importM1.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                var memoryMapping = Generator.GENERATOR_CACHE.get(generator.getSelectedItem()).getMappingLoader().getMapping(mappingName);
        ...
        configuration.add(HelpUtils.wrapWithHelpButton(this.withEntry("pluginmappings/mcreatormaptemplate"), L10N.label("elementgui.pluginmappings.mcreator_map_template")));
        ...
        jTable.setDefaultRenderer(String.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int rowIndex, int column) {
                ...
                if (value != null) label.setToolTipText(value.toString());
                return label;
            }
        });
        jTable.setDefaultEditor(String.class, new DefaultCellEditor(new JTextField()) {
            ...
            public Component getTableCellEditorComponent(JTable table, Object value1, boolean isSelected, int rowIndex, int column) {
                ...
                if (columns[column].equals("Mapping")) {
                    ...
                    int op = JOptionPane.showConfirmDialog(mcreator, jTextArea, "Edit Mapping", JOptionPane.YES_NO_OPTION);
        ...
        impfile.addActionListener(e -> {
            ...
            var memory = Generator.GENERATOR_CACHE.get(generator.getSelectedItem()).getMappingLoader().getMapping(mappingname);
            if (memory == null) {
                if (datalist != null) {
                    for (DataListModElement.DataListEntry entry : ((DataListModElement) Objects.requireNonNull(datalist.getGeneratableElement())).entries) {
                ...
                for (Map.Entry<?, ?> entry : memory.entrySet()) {
                    ...
                    if (!key.matches("(_default|_mcreator_map_template)")) {
                        ...
                        if (entry.getValue() instanceof List<?> list) {
                            ...
                            mappingsContent.add(new MappingsModElement.MappingEntry(key, new ArrayList<>(List.of(entry.getValue().toString()))));
                        }
                    }
                }
                if (datalist != null) {
        ...
        addPage("edit", PanelUtils.totalCenterInPanel(PanelUtils.northAndCenterElement(configuration, mapping))).validate(generator).validate(datalistName);
    }

    @Override
    protected void openInEditingMode(MappingsModElement generatableElement) {
        ...
        mappingsContent = generatableElement.mappingsContent;
    }

    @Override
    public MappingsModElement getElementFromGUI() {
        ...
        element.mappingsContent = mappingsContent;
        return element;
    }
    ...
    public void reloadDataLists() {
        ...
        for (ModElement element : mcreator.getWorkspaceInfo().getElementsOfType(ModElementTypes.DATA_LIST.getRegistryName())) {
